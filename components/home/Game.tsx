  ...
  return (
    <div>
      ...
      <Transition in={true} timeout={300}>
        {(state) => (
          <div
            className={`relative h-[475px] w-[510px] bg-gradient-game rounded-[10px] console-${state} hidden game-screen:block`}
          >
            ...
            <div className="flex p-[35px] border border-[#0C1616] text-white h-full w-full relative shadow-inner-game rounded-lg">
              <div className="relative rounded-lg h-[405.32px] w-[238.69px] bg-black-light/[.84] h-full shadow-inner-snake grid grid-cols-game">
                  ...
                  return row.map((cell, xc) => {
                    ...
                    return (
                      <div
                        ...
                        className={`
                                        ${
                                          isSnakeHead(xc, yc) && directionRef.current.x === 1
                                        ...
                                        ${
                                          isSnakeHead(xc, yc) && directionRef.current.y === 1
                                        ...
                                        ${
                                          foodRef.current.x === xc && foodRef.current.y === yc
                                            ? 'bg-green-light opacity-100 rounded-full shadow-hover-button'
                                            : ''
                                        }
                                    `}
                        style={{ opacity }}
                ...
                {gameOver ? (
                  <div className="w-full absolute top-[264px]">
                    <div className="text-green-light top-[264px] py-3 justify-center rounded-lg flex self-center bg-black-light/[.84] text-2xl shadow-inner-snake">
                      {foodCollected === 10 ? 'WELL DONE!' : 'GAME OVER!'}
                    </div>
                    <button
